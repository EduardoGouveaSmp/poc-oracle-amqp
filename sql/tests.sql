...
insert into broker (BROKER_ID,HOST,PORT,VHOST,USERNAME,PASSWORD) values (1,'127.0.0.1',5671,'/','guest','guest');
insert into broker (BROKER_ID,HOST,PORT,VHOST,USERNAME,PASSWORD) values (1,'127.0.0.1',5672,'/','guest','guest');
insert into broker (BROKER_ID,HOST,PORT,VHOST,USERNAME,PASSWORD) values (1,'127.0.0.1',5673,'/','guest','guest');
